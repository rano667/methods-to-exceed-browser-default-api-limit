...
Http2 api allowed multiplexing. So, by making a single tcp handshake all the api calls can be pushed and simultaneously. Hence, browser limit of max 6 api call doesn't apply in this case. Therefore, exceeding the default browser limit.
